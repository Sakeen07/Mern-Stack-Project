    ...
    <Dialog PaperProps={{style: {borderRadius:20}}} open={true}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          alignContent={'center'}>
            ...
            <Button sx={{mt:2, borderRadius:10, bgcolor:"#2b2d42"}} type="submit" fullWidth variant="contained">Login</Button>
            {!isAdmin && (
            <Button
            onClick={()=>setIsSignup(!isSignup)} 
            sx={{mt:2, borderRadius:10}} fullWidth>Back to {isSignup?"Login": "Signup" }
            </Button>
            )}
          </Box>
        </form>
